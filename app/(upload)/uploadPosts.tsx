...
import { ScrollView, Text, TouchableOpacity, View, Button, Image, TextInput, ActivityIndicator, Alert } from "react-native";
  ...
  const header = useHeaderBar({
    left: (
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        <Text style={styles.titleU}>Posts</Text>
      </View>
    ),
    center: null,
    right: (
        ...
        <ScrollView style={styles.scrollViewE}>
          <TouchableOpacity style={styles.panel1} >
            <View style={styles.panelAccountE}>
              <Text style={styles.paragraphE}>Create Posts</Text>
              <TouchableOpacity>
